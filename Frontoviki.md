...
1. Общий ui/ux 
    * Общий грид карточек
        - Три разных уровня платных объявлений, которые выделяется на фоне остальных.
        ...
        - Баг: Из за горизонтального расположения, если цена и адрес достаточно большие, то элементы могут 'вылезти' за пределы карточки. ![карточка](./img/large.png)
    * Локализация
...
3. Страница просмотра объявления
    * Общий вид
        - Два блока информации - блок информации о товаре и блок дополнительной информации(о продавце).
        - Логическое разделение блоков информации горизонтальными линиями - адрес сделки и состояние товара, информация от продавца(описание), прочая информация(количество просмотров, количество добавлений в избранное, дата публикации).
    ...
    * Кнопка чата и кнопка добавить в корзину
        ...
        - Если пользователь неавторизован, открывается окно регистрации/авторизации.
...
7. Профиль
    1. Страница объявлений
        - Основная страница профиля, большинство редиректов происходит на нее.
        ...
        * Просмотр
            ...
            - Наверхну есть 3 кнопки - показывать активные объявления, показывать объявления в архиве и кнопка удаления.
    ...
    2. Избранное
        ...
        - Если нет объявлений, то отображается картинка, что 'в избранном ничего нет'.
    ...
    6. Платные услуги
        - Сетка активных объявлений, при клике на какое-либо объявления попадаем на страницу продвижения.
