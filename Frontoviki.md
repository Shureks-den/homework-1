...
1. Общий ui/ux 
    * Общий грид карточек
        ...
        - Если элемент в фокусе - курсор сменяется на поинтер.
    ...
    * Локализация
        ...
        - Переводит весь текст на всех страницах, кроме пользовательского(имена, объявления, их описание) текста и Яндекс.Карт.
    ...
    * Хэдер
        ...
        * В выпадающем меню кнопки для редиректа в профиль, избранное, настройки и логаута.
    * Категории
...
2. Регистрация и авторизация
    * Форма авторизации
        - Обрабатывается пустой инпут почты в авторизации.
    ...
    * Форма регистрации
        - Обрабатываются пустые инпуты, но при этом инпут повторите пароль ведет себя как корректный инпут. ![reg](./img/regForm.png)
...
3. Страница просмотра объявления
    ...
    * Карусель с фотографиями
        - Возможность выбрать какую-либо конкретную фотографию с помощью элементов под блоком каруселе, либо переключать их последовательно.
    * Блок с продавцом
        - Краткая информация о продавце (имя, фамилия, рейтинг, дата регистрации, аватар).
        - Редирект на страницу продавца при нажатии на его имя или аватар(смена курсора на поинтер).
    * Кнопка чата и кнопка добавить в корзину
        - Можно добавить в корзину/избранное.
...
6. Страница редактирования объявления
    ...
    - При нажатии на кнопку 'редактировать' происходит редирект на страницу редактирования, она выглядит идентично странице создания объявления, только инпуты уже заполнены.
...
7. Профиль
    ...
    2. Страница объявлений
        ...
        - Если какая то из категорий пуста, то отображается специальная подсказка и картинка, что активных/архивных объявлений нет.
        * Просмотр
            ...
            - У активных объявлений можно по клику перейти на их страницу, у объявлений в архиве - нельзя.
        * Удаление
